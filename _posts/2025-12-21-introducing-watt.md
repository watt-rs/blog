...
Hi there! If you like the idea of languages that **help you think**, not fight you — you might enjoy Watt.
...
- ❌ `null` — because absence of a value should be explicit  
- ❌ exceptions — `Result[V, E]` type and panics instead
- ✅ clear error messages  
- ✅ a practical, predictable type system  
- ✅ pattern matching that reads like normal code  

Watt encourages good design: state is expressed in types, logic is verified by the compiler, not just by comments.

> ⚠️ **Status:** Watt is a work in progress. Syntax and features may change.
...
```
*An example of clear, readable conditionals — the compiler helps you get it right.*
...
*Every case is handled explicitly — no surprises at runtime.*

---

## 📡 Communication example: Satellite & Dish
...
## 🛰️ Pattern matching with a satellite
...
*Handling all possible outcomes cleanly — the compiler ensures nothing is forgotten.*

---

## 🍄 A playful example: Mushrooms
...
*A practical loop with a clear stop condition — no accidental infinite loops.*
...
## 🧠 Proposal: Why Watt exists

### 🧩 How types help you make fewer mistakes
...
## 👥 Who Watt is for (and who it isn’t)
...
Watt is opinionated — and intentionally so. It serves developers who value **correctness, readability, and long-term maintainability**.

---

## 🧪 TypeScript vs Watt: a small but real example
...
*TypeScript lets you get tripped up — Watt keeps it safe from the start.*
...
If you believe a language should **help you write correct code**, not fight you — welcome.  
